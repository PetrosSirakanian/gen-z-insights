...
* Pearson-Korrelation
* Pivot- und Gruppentabellen
* Multiple lineare Regression
* Visualisierungen (Boxplots, Streudiagramme)
...
Nur **1,60 %** der Befragten gaben für traditionelle Werbung den höchsten Wert (5) an, während dies bei Influencer-Werbung **13,74 %** waren.
...
Mobile Apps und Websites machen zusammen **64,52 %** der genannten Präferenzen aus.

In der vorliegenden Stichprobe werden somit Online-Shopping-Kanäle häufiger bevorzugt als der Einkauf im stationären Geschäft.
...
Das korrigierte **R² beträgt 0,782**. Das Modell erklärt damit etwa **78,2 % der Varianz** der monatlichen diskretionären Ausgaben.
...
Zwischen Alter und monatlichen diskretionären Ausgaben besteht ein **negativer statistisch signifikanter Zusammenhang** (**β = -2,1; p = 0,010**).

Innerhalb der vorliegenden Stichprobe sind höhere Alterswerte somit mit niedrigeren monatlichen diskretionären Ausgaben verbunden, wenn Einkommen und tägliche Bildschirmzeit konstant gehalten werden.
...
Die praktische Bedeutung des Koeffizienten sollte anhand der Skalierung interpretiert werden. Ein Koeffizient von 0,01 bedeutet beispielsweise, dass ein um 10.000 US-Dollar höheres Jahreseinkommen mit etwa **100 US-Dollar höheren monatlichen diskretionären Ausgaben** verbunden wäre, sofern die übrigen Variablen konstant gehalten werden.

## Schlussfolgerung

Anhand der vorliegenden Stichprobe zeigt sich ein negativer Zusammenhang zwischen Alter und monatlichen diskretionären Ausgaben.

Die tägliche Bildschirmzeit weist dagegen keinen statistisch signifikanten Zusammenhang mit den monatlichen diskretionären Ausgaben auf.
